    ...
    <section className="w-full">
      ...
      <div className="flex flex-col md:flex-row w-full mb-20">
        <div className="md:w-1/2 h-1/2 md:h-auto p-12">
          <img src='https://img-v2.gtsstatic.net/reno/imagereader.aspx?imageurl=https%3A%2F%2Fsir.azureedge.net%2F1103i0%2Fw0rqd2pcgj9sm9ttw0qbqkwzn0i&option=N&h=760&permitphotoenlargement=false' alt="About Us" className="object-cover w-full h-full" />
        </div>
